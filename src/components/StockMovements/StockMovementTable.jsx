...
function getMovementClass(type) {
  if (type === "Alış Girişi" || type === "İade Girişi" || type === "Satış İptali" || type === "Sayım Fazlası") return "movement-in";
  if (type === "Satış Çıkışı" || type === "İade Çıkışı" || type === "Alış İptali" || type === "Sayım Eksiği") return "movement-out";
